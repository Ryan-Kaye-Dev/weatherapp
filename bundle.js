...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ getWeather)\n/* harmony export */ });\n\r\n\r\nasync function getWeather(parameter) {\r\n    const response = await fetch(`https://api.weatherapi.com/v1/current.json?key=442ebb5fc99c4cee850165546230208&q=${parameter}`);\r\n    const data = await response.json();\r\n    console.log(data);\r\n    \r\n    const weatherCard = document.getElementById('weather-card');\r\n    const currentCondition = weatherCard.querySelector('.current-condition');\r\n    const locationElement = weatherCard.querySelector('.location');\r\n    const regionElement = weatherCard.querySelector('.region');\r\n    const countryElement = weatherCard.querySelector('.country');\r\n    const dateAndTimeElement = weatherCard.querySelector('.date-and-time');\r\n    const tempCElement = weatherCard.querySelector('.temp-c');\r\n    const tempFElement = weatherCard.querySelector('.temp-f');\r\n    const humidityElement = weatherCard.querySelector('.humidity');\r\n    const weatherIcon = weatherCard.querySelector('#weather-icon');\r\n\r\n    currentCondition.textContent = data.current.condition.text.toUpperCase();\r\n    locationElement.textContent = `${data.location.name}, ${data.location.country}`.toUpperCase();\r\n    dateAndTimeElement.textContent = data.location.localtime.substr(-5);\r\n    tempCElement.innerHTML = `${data.current.temp_c}<sup>°C</sup>`;\r\n    tempFElement.innerHTML = `${data.current.temp_f}<sup>°F</sup>`;\r\n    humidityElement.textContent = `HUMIDITY: ${data.current.humidity}%`;\r\n    weatherIcon.src = data.current.condition.icon;\r\n\r\n    // Show the weather card after updating the content\r\n    weatherCard.classList.remove('hidden');\r\n  }\r\n  \n\n//# sourceURL=webpack://weatherapp/./src/weatherAPI.js?");
...
eval("module.exports = __webpack_require__.p + \"98a55a7ddf04bf9e039c.jpg\";\n\n//# sourceURL=webpack://weatherapp/./src/night.jpg?");
...
eval("module.exports = __webpack_require__.p + \"796bf957792019bc8d0c.svg\";\n\n//# sourceURL=webpack://weatherapp/./src/search.svg?");
